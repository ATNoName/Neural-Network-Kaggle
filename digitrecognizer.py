...
def main():
    ...
    train_set, val_set = t.utils.data.random_split(data, [split, len(data) - split])
    ...
    batch_size = 1000
    # Train the model
    neural.train_model(model, train_set, val_set, criterion, optimizer, 5000, batch_size, 0.99)
    ...
    d.write_prediction('digit-recognizer/predictions.csv', predictions)
